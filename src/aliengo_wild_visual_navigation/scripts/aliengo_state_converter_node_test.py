...
vector_state.dim = 7 + 6  # + 4 * 12 (old values) (7 for pose, 6 for twist)
...
if __name__ == "__main__":
    ...
    ref_twist_sub = rospy.Subscriber("/normalized_pinocchio_leg_forces_magnitude", FootForces, twist_msg_callback, queue_size=20)
